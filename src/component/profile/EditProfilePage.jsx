...
function EditProfilePage() {
    ...
    const [formData, setFormData] = useState({
        ...
        address: '',
        city: '',
        profileImage: null, // Include profileImage to track it in the form
    });
    ...
    const validateForm = () => {
        const { username, email, phone, address, city } = formData;
        return username && email && phone && address && city;
    };
    ...
    return (
        <div className="relative w-full h-screen bg-gradient-to-b from-[#f70767] flex items-center justify-center">
            <div className="bg-white rounded-2xl shadow-lg p-8 max-w-3xl w-full">
                ...
                <h2 className="text-center text-2xl font-bold mb-6 text-[#f70767]">Update Your Profile</h2>
